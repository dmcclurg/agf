...
function parse_cache_feed($usernames, $limit) {
	...
	$cache_file = dirname(__FILE__).'/twitter_cache/' . $usernames_for_file . '-twitter-cache';
			...
			?>
				<li class="twitter-item">
					<p class="twitter-message">
						...
						<span class="twitter-arrow"></span><span class="twitter-timestamp">Posted <?php echo $pretty_time; ?></span>
					</p>
				</li>
			<?php
		}
